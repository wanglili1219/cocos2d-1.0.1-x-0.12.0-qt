...
public:
    ...
    */
    virtual bool initInstance(HWND hWnd, LPCTSTR szTitle, UINT wWidth,UINT wHeight) = 0;
    ...
    */
   // int run();
	int run(HWND hWnd = NULL, LPCTSTR szTitle = NULL,UINT wWidth= 0,UINT wHeight = 0);
    /**
